                ...
                <div className="max-w-6xl mx-auto relative">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
                        {posts.map((post) => {
                            ...
                            // Works whichever field names your User schema actually uses.
                            // Adjust these fallback chains once you confirm the schema field names.
                            ...
                            const authorImage =
                                authorObj.image ||
                                authorObj.avatar ||
                                authorObj.profileImg ||
                                authorObj.profilePic ||
                                null;
