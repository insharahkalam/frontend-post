...
// // //                             >
// // //                                 {/* Image */}
// // //                                 <div className="h-64 bg-[#0a1115] overflow-hidden">
// // //                                     {post.image ? (
// // //                                         <img
// // //                                             src={post.image}
...
// // //                                     <p className="text-white/30 text-[12.5px] line-clamp-2 font-light mt-2 leading-relaxed line-clamp-3">
// // //                                         {post.content || "No summary available."}
// // //                                     </p>

// // //                                     {/* Footer */}
// // //                                     <div className="flex items-center justify-between mt-5 border-t border-white/[0.06]">
...
// //                             <div
// //                                 key={post._id}
// //                                 className="group flex flex-col h-full bg-[#0c1418] border border-white/[0.07] rounded-[20px] overflow-hidden shadow-[0_0_40px_rgba(0,0,0,0.5)] hover:border-cyan-400/20 hover:shadow-[0_0_50px_rgba(34,211,238,0.05)] transition-all duration-300 hover:-translate-y-0.5"
// //                             >
// //                                 {/* Image */}
// //                                 <div className="h-72 w-full bg-[#0a1115] overflow-hidden shrink-0">
// //                                     {post.image ? (
// //                                         <img
// //                                             src={post.image}
// //                                             className="w-full h-full object-cover group-hover:scale-[1.03] transition duration-500"
...
// //                                     <p className="text-white/30 text-[12.5px] font-light mt-2 leading-relaxed line-clamp-3 flex-1">
// //                                         {post.content || "No summary available."}
// //                                     </p>
...
//                             <button
//                                 onClick={() => navigate("/")}
//                                 className="inline-flex items-center gap-2 px-5 py-2.5 rounded-[9px] bg-cyan-400 text-[#05080a] text-[13px] font-bold font-serif tracking-wide transition-all duration-150 hover:bg-cyan-300 hover:-translate-y-px active:translate-y-0"
//                             >
//                                 <FaPlus />
//                                 New Article
//                             </button>
